...
Les nouveaux constructeurs introduits nous pouvons maintenant enrichire notre language, voici les nouvelles règles de typage 
en figure~\ref{fig:typage dependant}
...
En général dans les types dépendants le terme $\forall$ et appelé \emph{Pi} nous garderons cette convention.
...
%a mettre après avoir présenté le système formelle
\begin{example}
  L'ensemble des termes exprimables avec un système de typage simple est inclus dans l'ensemble des termes des types dépendants.
...
C'est un très bon exemple pour présenter les types dépendants 
