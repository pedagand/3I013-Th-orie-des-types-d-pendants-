...
\]
  ...
  \todo{il faut que je retrouve le terme que j'avais présenté à frederic}
...
Commençons par implémenter nos termes dans notre programme:
...
\cfrac{\Gamma \vdash f \in A\rightarrow B \quad \Gamma\vdash A \ni s }
      {\Gamma\vdash \App{f}{s}\in B}\mbox{(App)} 
\medskip\\
\cfrac{\Gamma\vdash T \ni t}
      {\Gamma\vdash \Ann{t}{T} \in T}\mbox{(Ann)} 
\end{array}\]
