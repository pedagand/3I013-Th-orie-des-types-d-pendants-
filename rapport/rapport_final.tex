...
\begin{example}
  ...
  je vais faire le typage du terme $\lambda x. \lambda y. x y$ avec le type (int -> bool) -> int -> bool 
  ...
  et après juste une application sans $\lambda$ par dessus
\end{example}
...
car nous souhaitions évaluer les termes vers une forme normale faible.  
...
\todo{Question?: présentation 1 ou 2}
\begin{align*}
  \cfrac{}
  {x \leadsto x} \\
  \cfrac{}
