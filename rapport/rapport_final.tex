...
Regardons maintenant le constructeur $\land$ signifiant le \emph{et} logique, dont voici la règle de 
formation:
\begin{align*}
...
On reconnait ici le produit cartésien que l'on avait introduit dans notre $\lambda$-calcul simplement typé.
...
Précédement nous avions d'une part les termes et d'autre part les types.
Désormais nous allons tout mettre à plat
