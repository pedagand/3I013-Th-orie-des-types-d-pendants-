...
pas à l'intérieur des abstractions.  Pour certains termes on ne peut
pas atteindre une forme normale, cependant celle ci a moins de risque
de rentrer dans une boucle d'évaluation infinie. Nous n'avons pas
encore les proprités offertes par les systèmes de types tel que un
terme correctement typé se réduit toujours.
